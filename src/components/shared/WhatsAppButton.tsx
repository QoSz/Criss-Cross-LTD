...
export const WhatsAppButton = (): JSX.Element => {
  ...
  return (
    ...
    >
      ...
      <span className="absolute inset-2 rounded-full bg-green-500 opacity-35 animate-ping" aria-hidden="true"></span>

      <FloatingTooltip id="whatsapp-tooltip" text="Chat with us on WhatsApp" />
    </button>
  );
}; 