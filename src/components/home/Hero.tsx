...
export default function Hero() {
  return (
    <div className="relative flex flex-col min-h-screen items-center justify-center bg-gradient-to-br from-zinc-50 via-blue-50/30 to-indigo-100/20 dark:from-zinc-900 dark:via-blue-950/30 dark:to-indigo-900/20 text-slate-950 transition-colors w-full overflow-x-hidden">
